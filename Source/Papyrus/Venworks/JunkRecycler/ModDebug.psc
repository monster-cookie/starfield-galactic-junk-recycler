...
Function FeatureFlags() Global
  ...
  Venworks:JunkRecycler:ModConfig:Datafiles ConfigDatafiles = new Venworks:JunkRecycler:ModConfig:Datafiles
  GlobalVariable VJR_DebugMode = Game.GetFormFromFile(0x00000A39, ConfigDatafiles.Main) as GlobalVariable
  Perk VJR_PERK_Activator = Game.GetFormFromFile(0x00000A38, ConfigDatafiles.Main) as Perk
...
Function ResetSettings() Global
  ...
  GlobalVariable VJR_BreakdownQuantity_TierA = Game.GetFormFromFile(0x00000815, ConfigDatafiles.Main) as GlobalVariable
  GlobalVariable VJR_BreakdownQuantity_TierB = Game.GetFormFromFile(0x00000816, ConfigDatafiles.Main) as GlobalVariable
  GlobalVariable VJR_BreakdownQuantity_TierC = Game.GetFormFromFile(0x00000817, ConfigDatafiles.Main) as GlobalVariable
  GlobalVariable VJR_BreakdownQuantity_TierD = Game.GetFormFromFile(0x00000819, ConfigDatafiles.Main) as GlobalVariable
  ...
  GlobalVariable VJR_BreakdownChance_TierA = Game.GetFormFromFile(0x00000811, ConfigDatafiles.Main) as GlobalVariable
  GlobalVariable VJR_BreakdownChance_TierB = Game.GetFormFromFile(0x00000812, ConfigDatafiles.Main) as GlobalVariable
  GlobalVariable VJR_BreakdownChance_TierC = Game.GetFormFromFile(0x00000813, ConfigDatafiles.Main) as GlobalVariable
  GlobalVariable VJR_BreakdownChance_TierD = Game.GetFormFromFile(0x00000814, ConfigDatafiles.Main) as GlobalVariable
