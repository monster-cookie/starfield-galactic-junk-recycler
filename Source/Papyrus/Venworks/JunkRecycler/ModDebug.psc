...
Function FeatureFlags() Global
  ...
  GlobalVariable VJR_DebugMode = Game.GetFormFromFile(0x00000A39, "Venworks-JunkRecycler.esl") as GlobalVariable
  Perk VJR_PERK_Activator = Game.GetFormFromFile(0x00000A38, "Venworks-JunkRecycler.esl") as Perk
...
Function ResetSettings() Global
  ...
  GlobalVariable VJR_BreakdownQuantity_TierA = Game.GetFormFromFile(0x00000815, "Venworks-JunkRecycler.esl") as GlobalVariable
  GlobalVariable VJR_BreakdownQuantity_TierB = Game.GetFormFromFile(0x00000816, "Venworks-JunkRecycler.esl") as GlobalVariable
  GlobalVariable VJR_BreakdownQuantity_TierC = Game.GetFormFromFile(0x00000817, "Venworks-JunkRecycler.esl") as GlobalVariable
  GlobalVariable VJR_BreakdownQuantity_TierD = Game.GetFormFromFile(0x00000819, "Venworks-JunkRecycler.esl") as GlobalVariable
  ...
  GlobalVariable VJR_BreakdownChance_TierA = Game.GetFormFromFile(0x00000811, "Venworks-JunkRecycler.esl") as GlobalVariable
  GlobalVariable VJR_BreakdownChance_TierB = Game.GetFormFromFile(0x00000812, "Venworks-JunkRecycler.esl") as GlobalVariable
  GlobalVariable VJR_BreakdownChance_TierC = Game.GetFormFromFile(0x00000813, "Venworks-JunkRecycler.esl") as GlobalVariable
  GlobalVariable VJR_BreakdownChance_TierD = Game.GetFormFromFile(0x00000814, "Venworks-JunkRecycler.esl") as GlobalVariable
