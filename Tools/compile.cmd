...
REM mkdir "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist\textures\setdressing\terminals\splashscreens\"
...
@REM del /s /q "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Textures\*.*"
@REM rmdir /s /q "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Textures"
@REM mkdir "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Textures"
@REM mkdir "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Textures\textures\setdressing\terminals\splashscreens\"
...
copy /y "D:\MO2Staging\Starfield\mods\GalacticJunkRecycler-Experimental\GalacticJunkRecycler.esm" "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Source\ESM"
copy /y "D:\MO2Staging\Starfield\mods\GalacticJunkRecycler-Experimental\GalacticJunkRecycler.esm" "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist"

@REM Use Spriggit to extract record from ESM
"D:\Program Files\Spriggit\Spriggit.CLI.exe" serialize --InputPath "D:\MO2Staging\Starfield\mods\GalacticJunkRecycler-Experimental\GalacticJunkRecycler.esm" --OutputPath "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Source\ESM-Extracted" --GameRelease Starfield --PackageName Spriggit.Yaml

@REM Create and copy the BA2 Textures Archive to Dist folder
@REM @echo "Creating the BA2 Textures Archive"
@REM "D:\Program Files\xEdit\BSArch64.exe" pack "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Textures" "GalacticJunkRecycler - Textures.ba2" -sf1dds -mt && (
...
"D:\Program Files\xEdit\BSArch64.exe" pack "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Main" "GalacticJunkRecycler - Main.ba2" -sf1 -mt && (
...
@REM copy /y "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Textures\GalacticJunkRecycler - Textures.ba2" "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist"
copy /y "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist-BA2-Main\GalacticJunkRecycler - Main.ba2" "C:\Repositories\Public\Starfield Mods\starfield-galactic-junk-recycler\Dist"
